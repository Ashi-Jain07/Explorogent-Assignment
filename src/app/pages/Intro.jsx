    ...
    <>
      ...
      <div className="sm:flex mt-10">
        ...
        <div className="sm:w-1/2 mt-5 sm:m-2">
          <img src="/main.png" className="h-full" />
        </div>
      </div>
      ...
      <div className="bg-blue-100 mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 mlg:grid-cols-3 xl:grid-cols-4 place-items-center text-center gap-5 pt-8" >
          ...
          <div className="m-2">
            <img src="/management.png" width="40px" height="40px" className="border border-black rounded-full p-2 relative top-4 left-[125px] bg-white" />
          ...
          <div className="m-2">
            <img src="/deliveryIcon.png" width="40px" height="40px" className="border border-black rounded-full p-2 relative top-4 left-[125px] bg-white" />
            <div className="border border-black shadow-black shadow-md w-72 h-52 p-2">
          ...
          <div className="m-2">
            <img src="/mobile.png" width="40px" height="40px" className="border border-black rounded-full p-2 relative top-4 left-[125px] bg-white" />
            <div className="border border-black shadow-black shadow-md w-72 h-52 p-2">
          ...
          <div className="m-2">
            <img src="/website.png" width="40px" height="40px" className="border border-black rounded-full p-2 relative top-4 left-[125px] bg-white" />
            <div className="border border-black shadow-black shadow-md w-72 h-52 p-2">
        ...
        <div className="flex justify-center p-8">
          <div className="mlg:w-4/6 bg-blue-700 sm:flex justify-center place-items-center">
            <img src="/shoppingrecImage6.png" className="mt-5 p-5" />
